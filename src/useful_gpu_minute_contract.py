"""Useful-GPU-Minute Contract — SCAFFOLD STUB.

Company lens: Lambda (independent; no affiliation).
Bottleneck: differentiating GPU access when raw capacity increasingly commoditizes and customers care about reliable cluster performance and time-to-useful-compute
...
class UsefulGpuMinuteContract:
    ...
    - `evaluate(req)` returns a UsefulGpuMinuteContractReceipt
